...
export function ProjectSection({ projectSection, preloadedImages, key }) {
    ...
    useEffect(() => {
        if (!preloadedImages?.img && projectSection?.img) {
    ...
    return (
        <motion.div 
            ...
            exit={{opacity:0, duration: 0.2, x: -60}}
        ...
        >
            <div className="relative overflow-hidden rounded-md flex justify-center w-full">
                ...
                {projectImage ? (
                    <img
                        src={projectImage}
                        alt="Project Image"
                        className={`w-full h-[400px] rounded-md object-cover md:object-${projectSection?.objectPosition || 'center'}`}
                    />
                ) : (
                    ...
                    <div className="flex justify-center md:justify-start w-full">
                        {projectClientLogo && (
                            <div className="relative w-full">
                                <div className="h-[135px] bg-white/20 backdrop-blur-sm rounded-xs p-5 shadow-lg flex justify-center">
                                    <img
                                        src={projectClientLogo}
                                        alt={`${projectSection?.location} logo`}
                                        className="w-auto object-contain max-w-[120px] md:max-w-[150px]"
                                    />
                                </div>
                            </div>
                        )}
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 text-text-on-white-secondary">
                <div className="flex flex-col gap-3 w-full md:w-2/5">
                    ...
                    <SlideInAnimation y={50} delay={0.2}>
                ...
                <div className="flex flex-col gap-6 w-full md:w-3/5">
                    <SlideInAnimation y={50} delay={0.3}>
