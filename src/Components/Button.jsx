  ...
  "inline-flex items-center justify-center font-base transition-colors duration-300 focus:outline-none   disabled:pointer-events-none relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        "chip-node": "bg-surface-primary text-text-on-white-primary rounded-full py-1 px-3 text-body-sm hover:bg-surface-hover disabled:bg-surface-disabled disabled:text-text-disabled" ,
